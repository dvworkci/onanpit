    ...
    <?php $this->load->view('admin/include/sidebar');?>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php for ($i=1; $i < 9; $i++) { ?>
                                                <tr>
                                                    <td><?php echo $i ?> .</td>
                                                    <td><a href="<?= base_url('sub-task');?>">Login</a></td>
                                                    <td><img src="<?= base_url();?>assets/admin/default/images/na.png" alt=""></td>                                                   
                                                    <td>
                    ...
                    <form action="">
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Image</label>
                                    <input type="file" placeholder="Enter" class="form-control">
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel">Edit Task</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
