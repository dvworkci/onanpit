                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label> Referals targets</label>
                                    <input type="text" placeholder="Enter  Referals targets" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" placeholder="Enter Number of referral" class="form-control">
                                </div>  
                            </div>
                        </div>
